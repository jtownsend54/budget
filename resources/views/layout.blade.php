        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('budget_categories') }}">
                ...
                <ul class="nav flex-column mb-2">
                    @foreach(\App\Budget::all()->sortByDesc('id') as $budget)
                        <li class="nav-item">
                            <a class="nav-link" href="/?budget_id={{ $budget->id }}">
...
<script src="//unpkg.com/gijgo@1.9.11/js/gijgo.min.js" type="text/javascript"></script>
